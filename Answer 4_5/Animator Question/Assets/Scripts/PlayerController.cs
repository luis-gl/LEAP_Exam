...
public class PlayerController : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && isGrounded && !isRolling) myRigidBody.velocity = Vector2.up * jumpSpeed;
        myRigidBody.velocity = new Vector2(horizontal  * currentHorizontalSpeed, myRigidBody.velocity.y);
        ...
        {
            textToShow = "ROLL";
            currentHorizontalSpeed = rollSpeed;
        }
        else currentHorizontalSpeed = walkSpeed;
